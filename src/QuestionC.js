...
<div className="grid-container">
    ...
    {(()=> {
          ...
          return (<label className="time-label" >Time Left: <label className="time-label" style={{color: "red"}}>0{minutes}:0{seconds}</label> </label>)
          }else{
          return(<label className="time-label">Time Left: 0{minutes}:0{seconds}</label>)
          }
          }
           else {
            return (<label className="time-label">Time Left: 0{minutes}:{seconds}</label>)
          }
...
{(()=> {
          if (count == 0) {
            return (<button className="btn btn-custom" onClick={dec_count} disabled>Back</button>)
          } else {
            return (<button className="btn btn-custom" onClick={dec_count}>Back</button>)
          }
        })()}
...
<button className="btn btn-custom ml-5" onClick={ans_q} >Next</button>)
            ...
            return (<button className="btn btn-custom ml-5" onClick={ans_q} disabled>Next</button>)
          }
        })()}
